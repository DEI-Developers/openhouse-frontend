        ...
        <div>
          ...
          >
            <button
              type="button"
              onClick={previusPage}
              className="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400  ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
            >
            ...
            {!empty(endPages) && (
              <>
                <span className="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-400  ring-inset ring-gray-300 focus:outline-offset-0">
                  ...
                </span>
                {endPages.map((page) => (
                  <CustomPage
            ...
            <button
              type="button"
              onClick={nextPage}
              className="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400  ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
            >
